 ...
 * Youtube : Aryo Coding
 */
class Mod_atlit extends CI_Model {
	...
	var $order = array('id_atlit' => 'desc'); // default order 
 ...
 private function _get_datatables_query()
    ...
    {   
       /* $this->db->select('a.*,b.nama_level');
        $this->db->join('tbl_userlevel b', 'a.id_level = b.id_level');
        $this->db->order_by('a.id_atlit desc');
        return $this->db->get('atlit a');
		*/
		return $this->db->get('atlit');
    }
    ...
    {   
        $this->db->where("id_atlit", $id);
        return $this->db->get("atlit a")->row();
    }
